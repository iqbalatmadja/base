...
<div class="max-w-[400px] mx-auto w-full">
    <div class="flex flex-col items-center mt-[5vh]">
        ...
        <form action="{{ route('login.process') }}" method="post">
            ...
            @endif
            <input type="password" class="w-full px-6 py-3 mb-2 border border-slate-600 rounded-lg font-medium  @error('password') is-invalid @enderror" id="password" name="password">
